"""
Django settings for emotion_server project.
...
ROOT_URLCONF = 'emotion_server.urls'
...
WSGI_APPLICATION = 'emotion_server.wsgi.application'
ASGI_APPLICATION = 'emotion_server.asgi.application'
