<template>
  <div class="animation-container">
    <!-- 인풋 애니메이션 원 -->
    <div class="circle-container" v-show="!animationStarted">
      <div class="circle" @click="startAnimation"></div>
    </div>
  ...
  const secondaryEmotions = computed(() => {
    return props.emotionData.secondary_emotions
      ? props.emotionData.secondary_emotions.map(emotion => Object.keys(emotion)[0])
      : [];
  });
