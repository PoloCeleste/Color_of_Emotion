...
.camera {
  ...
  height: 800px;
  position: relative;
  box-shadow: 0 0 0 8px #353535, /* 간격 축소 */ 0 0 0 16px #454545,
    0 0 0 24px #555555, 0 0 100px rgba(0, 0, 0, 0.5);
}
...
.lens {
  ...
  border-radius: 50%;
  box-shadow: 0 0 0 8px #404040,
    /* 간격 축소 */ inset 0 0 40px rgba(0, 0, 0, 0.7);
}
